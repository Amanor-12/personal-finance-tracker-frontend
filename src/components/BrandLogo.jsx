...
function BrandLogo({
  ...
  const fieldGradient = `ledgrLogoField-${id}`;
  const checkGradient = `ledgrLogoCheck-${id}`;
  ...
  return (
    ...
    >
      <svg aria-hidden="true" className="brand-logo-mark" viewBox="0 0 64 64">
        <defs>
          <linearGradient id={fieldGradient} x1="10" y1="8" x2="54" y2="56">
            <stop offset="0%" stopColor="#1982ff" />
            <stop offset="55%" stopColor="#12a0db" />
            <stop offset="100%" stopColor="#7ccf5e" />
          </linearGradient>
          <linearGradient id={checkGradient} x1="18" y1="44" x2="50" y2="18">
            <stop offset="0%" stopColor="#0e77af" />
            <stop offset="100%" stopColor="#afe26e" />
          </linearGradient>
        </defs>

        <rect x="6" y="6" width="52" height="52" rx="14" fill={`url(#${fieldGradient})`} />
        ...
        <path d="M23.6 42 31 49.4 54.4 24.8 58 24.2 33.6 56.2 26.6 48.6 18.4 48.8Z" fill={`url(#${checkGradient})`} />
      </svg>
