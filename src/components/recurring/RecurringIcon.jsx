function RecurringIcon({ type }) {
  const icons = {
    ...
    close: <path d="m5.1 5.1 5.8 5.8M10.9 5.1l-5.8 5.8" fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth="1.55" />,
    edit: (
      <>
    ...
    repeat: (
      <>
        <path d="M4.4 5.4h5.5a2.5 2.5 0 0 1 2.5 2.5v.2" fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth="1.45" />
        <path d="m10.4 3.6 2 1.8-2 1.8" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.45" />
        <path d="M11.6 10.6H6.1a2.5 2.5 0 0 1-2.5-2.5v-.2" fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth="1.45" />
        <path d="m5.6 12.4-2-1.8 2-1.8" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.45" />
      </>
    ),
    search: (
      <>
