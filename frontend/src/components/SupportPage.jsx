  ...
  const supportPaths = useMemo(
    () => [
      ...
      },
      {
        ...
        body: 'Track income, expenses, categories, notes, edits, and deletion from one ledger.',
        cta: 'Open transactions',
        keywords: 'transactions income expense category delete edit ledger',
        to: '/transactions',
      },
      {
        title: 'Plan spending',
  ...
  const faqItems = useMemo(
    () => [
      ...baseFaqItems,
      {
        ...
        answer: isPro
          ? 'Your workspace currently includes recurring payment tracking, reporting, unlimited planning, AI report briefings, cash forecasting, AI transaction review, and the deeper Pro workflow layer.'
          : isPlus
            ? 'Plus unlocks recurring payment tracking, reporting, exports, saved views, and AI report briefings. Pro adds cash forecasting, bulk ledger tools, AI transaction review, and stronger milestone guidance on top.'
            : 'Plus unlocks recurring payment tracking, reporting, exports, saved views, and AI report briefings. Pro adds cash forecasting, bulk ledger tools, AI transaction review, and stronger milestone guidance on top.',
      },
    ],
    [isPlus, isPro]
  ...
  const rail = (
    <aside className="support-concierge-rail">
      <article className="support-rail-card support-rail-card-dark">
        ...
        <h3>{isPro ? 'Pro workspace tools are active' : isPlus ? 'Paid workspace tools are active' : 'Self-serve support on Free'}</h3>
        <p>
          {isPro
            ? 'Billing, AI review, and higher-control Pro tools live inside the same workspace.'
            : isPlus
              ? 'Plus customers get guided product help around recurring control, exports, reporting, and AI briefings. Pro adds deeper workflow controls.'
    ...
    >
        ...
        <div className="support-hero-tools">
          ...
          <div className="support-plan-note">
            <div>
              ...
              <strong>
                {isPro
                  ? 'Pro tools, AI review, and milestone guidance are already available.'
                  : isPlus
                    ? 'Plus tools are active. Pro adds AI transaction review and deeper workflow controls.'
                    : 'Plus adds renewals, reports, and AI briefings. Pro adds AI transaction review and deeper workflow controls.'}
              </strong>
            </div>
      ...
      <section className="pricing-proof-grid pricing-signature-grid" aria-label="Support tier guidance">
        ...
        <article>
          ...
          <p>Pro is where AI transaction review, bulk ledger controls, and deeper milestone guidance start to justify a more serious subscription.</p>
        </article>
      </section>
    </FinanceLayout>
  );
